...
# picture
rock_img = ImageTk.PhotoImage(Image.open("urock.png"))
paper_img = ImageTk.PhotoImage(Image.open("upaper.png"))
scissor_img = ImageTk.PhotoImage(Image.open("uscissor.png"))
rock_img_comp = ImageTk.PhotoImage(Image.open("crock.png"))
paper_img_comp = ImageTk.PhotoImage(Image.open("cpaper.png"))
scissor_img_comp = ImageTk.PhotoImage(Image.open("cscissor.png"))
